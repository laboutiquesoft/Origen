...
export interface GroupsSectionFilterValues {
  search: string;
  status: string;
  startDate: string;
  endDate: string;
...
interface GroupsSectionFilterProps {
  filters: GroupsSectionFilterValues;
  onFilterChange: (newFilters: GroupsSectionFilterValues) => void;
  onResetFilters: () => void;
  totalResults?: number;
}

export const GroupsSectionFilter: React.FC<GroupsSectionFilterProps> = ({
  filters,
  onFilterChange,
  onResetFilters,
  totalResults,
}) => {
  const handleChange = (field: keyof GroupsSectionFilterValues, value: string) => {
    onFilterChange({
      ...filters,
      [field]: value,
    });
...
export default GroupsSectionFilter;